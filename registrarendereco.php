<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') 
    {
        ...
        if(!$erro)
        {
            $sql = "INSERT INTO tb_endereco (I_COD_PESSOA, S_END_ENDERECO, S_BAI_ENDERECO, S_CID_ENDERECO, S_UF_ENDERECO, S_CEP_ENDERECO) VALUES ($id, '$endereco', '$bairro', '$cidade', '$UF', '$CEP')";
...
<head>
    ...
    <title>DrogaZilla - Registrar Endereço</title>
</head>
